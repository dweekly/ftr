...
mod tests {
    ...
    fn test_transit_classification_no_asn_public_ip() {
        ...
        assert_eq!(segment, SegmentType::Transit, 
    ...
    fn test_destination_segment_with_matching_asn() {
        ...
        assert_eq!(segment, SegmentType::Destination,
    ...
    fn test_isp_segment_classification() {
        ...
        assert!(crate::traceroute::is_cgnat(&cgnat_ip), 
    ...
    fn test_lan_segment_classification() {
        ...
        for ip in private_ips {
            assert!(crate::traceroute::is_internal_ip(&ip),
                "{} should be classified as internal/LAN", ip);
        }
        ...
        for ip in public_ips {
            assert!(!crate::traceroute::is_internal_ip(&ip),
                "{} should NOT be classified as internal/LAN", ip);
        }
    }
